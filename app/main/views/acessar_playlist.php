            ...
            <main class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <?php foreach ($playlists as $playlist) { ?>
                        ...
                        ?>
                        <div class="bg-ceara-gray rounded-lg p-4 hover:bg-ceara-gray/80 transition-all duration-300">
                            <div class="flex items-center space-x-4">
                                <i class="fas fa-music text-ceara-white text-2xl"></i>
                                <div>
                                    <a href="playlist.php?nome_playlist=<?= $playlist['nome_playlist'] ?>" class="text-ceara-white font-bold text-lg"><?= $playlist['nome_playlist'] ?></a>
                    ...
                    <div
                        class="bg-ceara-gray rounded-lg p-4 hover:bg-ceara-gray/80 transition-all duration-300 cursor-pointer">
                        <a href="criar_playlist.php">
                            <div class="flex items-center justify-center h-full">

                                <div class="text-center">
                                    <i class="fas fa-plus text-4xl text-ceara-white mb-2"></i>
                                    <p class="text-ceara-white font-bold">Criar Nova Playlist</p>
                                </div>
                    ...
                    <?php
                    if (!empty($playlist['nome_playlist'])) {
                    ?>
                        <div
                            class="bg-ceara-gray rounded-lg p-4 hover:bg-ceara-gray/80 transition-all duration-300 cursor-pointer">
                            <a href="./deletar_playlist.php">
                                <div class="flex items-center justify-center h-full">

                                    <div class="text-center">
                                        <i class="fas fa-plus text-4xl text-ceara-white mb-2"></i>
                                        <p class="text-ceara-white font-bold">Deletar playlist</p>
                                    </div>
